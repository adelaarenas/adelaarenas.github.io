...
img: assets/img/co-60-energy-spectrum.png #img tag to put background image on projects landing page
importance: 1
category: work
...
## Overview
As part of my internship at the **Philippine Nuclear Research Institute (PNRI)**, I conducted the **energy and efficiency calibration of a sodium iodide (NaI(Tl)) scintillation detector** using standard gamma-ray sources **Cobalt-60 (Co-60)** and **Cesium-137 (Cs-137)**. 
